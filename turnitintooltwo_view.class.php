...
class turnitintooltwo_view {
    ...
    public function show_add_tii_tutors_form($cm, $tutors) {
        ...
        // START UCLA-MOD: CCLE-6336 - Turnitin Tutors show all those with grading capability
         ...
         */           
           ...
           $moodletutors = local_ucla_core_edit::get_course_graders($course, '', 'mod/turnitintooltwo:grade');
        // END UCLA-MOD: CCLE-6336
