...
$string['maxmarks'] = 'Maximum points';
...
$string['ppanonmarkingnote'] = 'Note: Anonymous Grading only applies to Turnitin GradeMark. It is controlled by the assignment post date within Turnitin. Turnitin will use the &#39;hidden until&#39; date as the post date, which can be set by editing the grade item in the Course gradebook report.';
...
$string['turnitinanon_help'] = 'You can configure your Turnitin assignment to use Anonymous Grading by setting this value to Yes. Once a submission is made anonymous grading cannot be disabled.';
